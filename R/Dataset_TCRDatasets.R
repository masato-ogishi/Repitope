...
#' \code{TCRSet_CD8} is a combined human CD8+ TCR repertoire. TCR clonotypes observed in at least 2 out of 6 donors were retained.
#' \code{TCRSet_PubClones10000} is a public TCR repertoire returned from \code{publicClonotypeAnalysis}. The size threshold was set 10000.
