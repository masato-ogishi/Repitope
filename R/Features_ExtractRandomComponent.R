#' Extract features generated from random sequences
#'
...
#' @export
#' @rdname Features_ExtractRandomComponent
#' @name Features_ExtractRandomComponent
Features_ExtractRandomComponent <- function(featureDFList){
  extract.random.rTPCP <- function(df){
