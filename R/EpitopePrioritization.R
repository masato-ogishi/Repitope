...
#' @param fragDepthSet A fragment library size. ## A vector of length one.
#' @param fragLibTypeSet A set of strings indicating the types of fragment libraries to be used. ## A vector of length one.
