...
#'
#' \code{Immunogenicity} is a wrapper function for training and evaluating a classifier of peptide immunogenicity. The optimized machine learning algorithm is used internally.\cr
#'
